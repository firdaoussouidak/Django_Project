...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-3h5j9(64onbvhc3c%9p11nmbpp+b55ke=arprr$sz%2@1dm_)5')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'posts.authentication.JWTAuthenticationWithoutDB',
    )
}
